...
// The pure classification/mapping helpers moved to the framework canonical
// (framework/utils/chain-errors.ts — S0 utils consolidation). The service
// below keeps delegating to them; the re-exports keep existing
// `@shared/services/NotificationService` imports working.
export { classifyChainError, mapChainError };
